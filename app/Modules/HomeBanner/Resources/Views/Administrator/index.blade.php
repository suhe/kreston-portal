                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="{!! url('home-banner/administrator/view/'.Crypt::encrypt($banner->id)) !!}"> {!! Lang::get('action.view') !!}</a></li>
                                        <li><a href="{!! url('home-banner/administrator/edit/'.Crypt::encrypt($banner->id)) !!}"> {!! Lang::get('action.edit') !!}</a></li>
