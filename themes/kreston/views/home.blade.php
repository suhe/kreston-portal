			  ...
			  <div class="navbar navbar-default" role="navigation">
				...
				<nav class="collapse collapsing navbar-collapse">
				  <ul class="nav navbar-nav navbar-center">
					<li class="item-bg item-danger"><a href="index.html" >Home</a></li>
					<li class="item-bg item-danger"><a href="about-us.html">About Us</a></li>
					<li class="item-bg item-danger"><a href="about-us.html">Services</a></li>
					  ...
					  <ul class="sub">
						<li class="sub-wrapper">
						  <div class="sub-list">
							<div class="box">
							  <ul>
								<li><a href="#"><i class="fa fa-caret-right"></i> Eddy Permana</a></li>
								<li><a href="#"><i class="fa fa-caret-right"></i> Tan Siddharta</a></li>
								<li><a href="#"><i class="fa fa-caret-right"></i> Wenna Chandra Tan</a></li>
								<li><a href="#"><i class="fa fa-caret-right"></i> Sawerdy Nababan</a></li>
					...
					<li class="item-bg item-danger"><a href="news.html">News</a></li>
					<li class="item-bg item-danger"><a href="article.html">Article</a></li>
					<li class="item-bg item-danger"><a href="gallery.html">Gallery</a></li>
					<li class="item-bg item-danger"><a href="career.html">Career</a></li>
					<li class="item-bg item-danger"><a href="contact-us.html">Contact Us</a></li>
